...
## Захват изоюражения с веб камеры, по умолчанию веб камера с id 0
capture = cv.VideoCapture(0)

# Подгружаем каскад с лицами
face_cascade = cv.CascadeClassifier('haarcascade_frontalface_default.xml')

## Цикл выводит изображение с вебки пока не нажмешь ESC
while True:
    ...
    k = cv.waitKey(30) & 0xFF # Ждет нажатия кнопки ESC 30 милисек и все это в интегрер
    if k == 27:
        break
